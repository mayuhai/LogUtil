...
import com.czm.library.encryption.imp.AESEncode;
...
//        email.setNamePass("betengapp","120120");
        ...
        email.setReceiver("hezemayuhai@163.com");//收件人
        email.setSender("hezemayuhai@163.com");//发送人邮箱
        email.setSendPassword("myh516910697myh");//邮箱密码
